                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="">
                                ...
                                <li>
                                    <a href="{{ route('periodekriteria') }}" class="side-menu side-menu--active">
                                        <div class="side-menu__icon"> <i data-feather="plus"></i> </div>
                ...
                <div class="content">
                    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                        <h2 class="text-lg font-medium mr-auto">
                            List Data Periode Kriteria
                        </h2>
                        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                            <div class="intro-y col-span-12 flex flex-weap sm:flex-nowrap items-center mt-2">
                                <button class="btn btn-primary shadow-md mr-2 modal-periode_kriteria">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h2 class="font-medium text-base mr-auto">
                                        Form Tambah Data Periode Kriteria
                                    </h2>
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    {{-- <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <input type="text" class="form-control create-kode_kriteria" name="kode_kriteria" id="kode_kriteria" placeholder="Masukkan Kode Kriteria" required>
                                    </div> --}}
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Kode Kriteria</label>
                                        <select class="form-select create-kode_kriteria" id="kode_kriteria" name="kode_kriteria">
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <input type="text" class="form-control create-bobot_kriteria" name="bobot_kriteria" id="bobot_kriteria" placeholder="Masukkan Bobot Kriteria" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Semester</label>
                                        <input type="text" class="form-control create-semester" name="semester" id="semester" placeholder="Masukkan Semester" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Tahun Ajar</label>
                                        <input type="text" class="form-control create-tahun_ajar" name="tahun_ajar" id="tahun_ajar" placeholder="Masukkan Tahun Ajar" required>
                                    </div>
                                </div>
                                <!-- END: Modal Body -->
                                <!-- BEGIN: Modal Footer -->
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Berhasil Menambahkan Data Periode Kriteria Baru!</div>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Oops...Gagal Menambahkan Data Periode Kriteria Baru!</div>
                    ...
                    <div id="modal-update" class="modal" tabindex="-1" aria-hidden="true" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h2 class="font-medium text-base mr-auto">
                                        Form Update Data Periode Kriteria
                                    </h2>
                                    <a data-dismiss="modal" href="javascript:;"> <i data-feather="x" class="w-8 h-8 text-gray-500"></i> </a>
                                </div>
                                <!-- END: Modal Header -->
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <input type="text" class="form-control update-kode_kriteria" name="kode_kriteria" id="kode_kriteria" placeholder="Masukkan Kode Kriteria" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Bobot Kriteria</label>
                                        <input type="text" class="form-control update-bobot_kriteria" name="bobot_kriteria" id="bobot_kriteria" placeholder="Masukkan Bobot Kriteria" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Semester</label>
                                        <input type="text" class="form-control update-semester" name="semester" id="semester" placeholder="Masukkan Semester" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Tahun Ajar</label>
                                        <input type="text" class="form-control update-tahun_ajar" name="tahun_ajar" id="tahun_ajar" placeholder="Masukkan Tahun Ajar" required>
                                    </div>
                                </div>
                                <!-- END: Modal Body -->
                                <!-- BEGIN: Modal Footer -->
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Berhasil update data Periode Kriteria baru!</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="x-circle" class="w-16 h-16 text-theme-23 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Oops...Gagal update data Periode Kriteria  baru!</div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Apa kamu yakin ingin hapus data Periode Kriteria ini?</div>
                                        <div class="text-gray-600 mt-2">
                                            Apa kamu yakin akan menghapus data Periode Kriteria ini?
                                            <br>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="check-circle" class="w-16 h-16 text-theme-10 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Hapus Data Periode Kriteria Berhasil!</div>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('#data-table').DataTable({
                    ...
                    "serverside": true,
                    "ajax": {
                        "url": "http://127.0.0.1:8000/api/periode-kriteria/list",
                        "dataType": "json",
                        "type": "POST",
                        "headers": {
                            'Authorization': 'Bearer ' + token
                    ...
                    "columns": [
                        ...
                        { data: 'tahun_ajar', className: 'text-center' },
                        {
                            ...
                            render: function (data, type, row){
                                ...
                                var editBtn = '<button class = "btn btn-primary btn-edit" data-id = "' + data.id + '" data-kode_kriteria = "' + data.kode_kriteria + '" data-bobot_kriteria = "' + data.bobot_kriteria + '" data-semester = "' + data.semester + '" data-tahun_ajar = "' + data.tahun_ajar + '" ><i data-feather = "edit" class = "w-4 h-4"> </i> </button>';
                ...
                $(".modal-periode_kriteria").click(function() {
                ...
                $(".btn-create").click(function() {
                    ...
                    $.ajax({
                        url: "http://127.0.0.1:8000/api/periode-kriteria/tambah-periode_kriteria",
                        type: 'POST',
                        dataType: 'json',
                        headers: {
                            "Authorization": "Bearer " + token
                        ...
                        success: function(response) {
                            ...
                            console.log('Data Periode Kriteria Berhasil di Tambahkan!');
                        ...
                        error: function(xhr, status, error) {
                            ...
                            console.log('Data Periode Kriteria Gagal untuk di Tambahkan. Status: ' + error);
                ...
                $(".btn-update").click(function() {
                    ...
                    // Validasi id
                    if (!id || id === "") {
                        alert("ID Periode Kriteria harus diisi!");
                    ...
                    // Kirim permintaan pembaruan produk ke API
                    $.ajax({
                        url: "http://127.0.0.1:8000/api/periode-kriteria/update-periode_kriteria/" + id,
                        type: "PUT",
                ...
                $('#data-table').on('click', '.btn-delete', function() {
                    ...
                    $('.hapus-btn').click(function() {
                        // Ajax delete Api
                        $.ajax({
                            url: "http://127.0.0.1:8000/api/periode-kriteria/hapus-periode_kriteria/" + id,
                            type: 'DELETE',
                            headers: {
                                'Authorization': 'Bearer ' + token
                            },
