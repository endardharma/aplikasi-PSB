...
<html lang="en" class="light">
    ...
    <head>
        ...
        <title> Nilai Prestasi Akademik / Non-Akademik</title>
        <!-- BEGIN: CSS Assets-->
    ...
    <body class="main">
        ...
        <!-- END: mobile menu -->
        <!-- BEGIN: top bar -->
        <div class="top-bar-boxed border-b border-theme-2 -mt-7 md:-,t-5 -m-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
            <div class="h-full flex items-center">
                ...
                <!-- END: logo -->
                <!-- BEGIN: breadcrumb -->
                <div class="-intro-x breadcrumb mr-auto"><a href="">Beranda</a><i data-feather="chevron-right" class="breadcrumb__icon"></i><a href="" class="breadcrumb--active">Nilai Prestasi Akademik / Non Akademik</a></div>
                <!-- END: breadcrumb -->
                <!-- BEGIN: notification -->
                ...
                <div class="intro-x dropdown w-8 h-8">
                    ...
                    <div class="dropdown-menu w-56">
                        <div class="dropdown-menu__content box bg-theme-11 dark:bg-dark-6 text-white">
                            ...
                            <div class="p-2">
                                <a class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"><i data-feather="user" class="w-4 h-4 mr-2"></i>Profile</a>
                                <a class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"><i data-feather="edit" class="w-4 h-4 mr-2"></i>Add Account</a>
                                <a class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"><i data-feather="lock" class="w-4 h-4 mr-2"></i>Reset Password</a>
                            </div>
                            <div class="p-2 border-t border-theme-12 dark:border-dark-3">
                                <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:bg-dark-3 rounded-md"><i data-feather="toggle-right" class="w-4 h-4 mr-2"></i>Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="wrapper">
            <div class="wrapper-box">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="">
                                ...
                                <li>
                                    <a href="{{ route('nilaiprestasi') }}" class="side-menu side-menu--active">
                                        <div class="side-menu__icon"> <i data-feather="plus"></i> </div>
                ...
                <div class="content">
                    ...
                    <div class="intro-y flex fle-col sm:flex-row items-center mt-8">
                        <h2 class="text-lg font-medium mr-auto">
                            List Data Nilai Prestasi Akademik / Non Akademik
                        </h2>
                        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                                {{-- <button class="btn btn-primary shadow-md mr-2 modal-prestasi">
                                    <span class="w-5 h-5 flex items-center justify center"><i class="w-4 h-4" data-feather="user-plus"></i></span>
                                </button> --}}
                                <button class="btn btn-primary shadow-md mr-2 modal-import_prestasi"> <!-- menampilkan button import data -->
                                    <span class="w-5 h-5 flex items-center justify center"> <i class="w-5 h-4" data-feather="file-plus"></i> </span>
                                </button>
                                <a href="{{ route('exportNilaiPrestasi') }}" class="btn btn-success btn-md shadow-md mr-2"> <!-- menampilkan button export data -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h2 class="font-medium text-base mr-auto">
                                        Import Data Prestasi Akademik / Non Akademik
                                    </h2>
                                    <a href="javascript:;" data-dismiss="modal"><i data-feather="x" class="w-8 h-8 text-gray-500"></i></a>
                                </div>
                                <form action="/halaman/import-prestasi" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <!-- END: Modal Header -->
                                    <!-- BEGIN: Modal Body -->
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Berhasil import data Prestasi Akademik / Non Akademik baru!</div>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Oops...Gagal import data Prestasi Akademik / Non Akademik baru!</div>
                    ...
                    <div id="modal-create" class="modal" tabindex="-1" aria-hidden="true" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h2 class="font-medium text-base mr-auto">
                                        Form Tambah Data Nilai Prestasi Akademik / Non Akademik
                                    </h2>
                                    <a href="javascript:;" data-dismiss="modal"><i data-feather="x" class="w-8 h-8 text-gray-500"></i></a>
                                </div>
                                <!-- END: modal header -->
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Keterangan Prestasi</label>
                                        <select class="form-select create-keterangan_prestasi">
                                            <option selected disabled>--Pilih Keterangan Prestasi Siswa--</option>
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Nilai Prestasi</label>
                                        <select class="form-select create-nilai_prestasi">
                                            <option selected disabled>--Pilih Nilai Prestasi Siswa--</option>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Berhasil Menambahkan Data Nilai Prestasi Akademik / Non Akademik Baru!</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="x-circle" class="w-16 h-16 text-theme-23 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Oops...Gagal Menambahkan Data Nilai Prestasi Akademik / Non Akademik Baru!</div>
                    ...
                    <div id="modal-update" class="modal" tabindex="-1" aria-hidden="true" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h2 class="font-medium text-base mr-auto">
                                        Form Update Data Nilai Prestasi Akademik / Non Akademik
                                    </h2>
                                    <a href="javascript:;" data-dismiss="modal"><i data-feather="x" class="w-8 h-8 text-gray-500"></i></a>
                                </div>
                                <!-- END: modal header -->
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Keterangan Prestasi</label>
                                        <select class="form-select update-keterangan_prestasi">
                                            <option selected disabled>--Pilih Keterangan Prestasi Siswa--</option>
                                            <option value="Tingkat Internasional Juara 1">Tingkat Internasional Juara 1</option>
                                            <option value="Tingkat Internasional Juara 2">TIngkat Internasional Juara 2</option>
                                            <option value="Tingkat Internasional Juara 3">Tingkat Internasional Juara 3</option>
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Nilai Prestasi</label>
                                        <select class="form-select update-nilai_prestasi">
                                            <option selected disabled>--Pilih Nilai Prestasi Siswa--</option>
                                            <option value="12">12</option>
                                            <option value="11">11</option>
                                            <option value="10">10</option>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="check-circle" class="w-16 sh-16 text-theme-10 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Berhasil update data Nilai Prestasi Akademik / Non Akademik baru!</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="x-circle" class="w-16 h-16 text-theme-23 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Oops...Gagal update data Nilai Prestasi Akademik / Non Akademik baru!</div>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Apa kamu yakin ingin hapus data Nilai Prestasi Akademik / Non Akademik  Guru ini?</div>
                                        <div class="text-gray-600 mt-2">
                                            Apa kamu yakin akan menghapus data Nilai Prestasi Akademik / Non Akademik  Guru ini?
                                            <br>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="check-circle" class="w-16 h-16 text-theme-10 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Hapus Data User Detail Berhasil!</div>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('#data-table').DataTable({
                    ...
                    "serverside": true,
                    "ajax": {
                        "url": "http://127.0.0.1:8000/api/nilai-prestasi/list",
                        "dataType": "json",
                        "type": "POST",
                        "headers": {
                            'Authorization': 'Bearer ' + token
                    ...
                    "columns": [
                        ...
                        {data: 'keterangan_prestasi', className: 'text-center'},
                        {data: 'nilai_prestasi', className: 'text-center'},
                        ...
                        { data: 'tahun_ajar', className: 'text-center' },
                        {
                            ...
                            render: function (data, type, row){
                                ...
                                // var editBtn = '<button class = "btn btn-primary btn-edit" data-id = "' + data.id + '" data-nama_siswa = "' + data.nama_siswa + '" data-keterangan_prestasi = "' + data.keterangan_prestasi + '" data-nilai_prestasi = "' + data.nilai_prestasi + '" data-kelas = "' + data.kelas + '" data-jurusan = "' + data.jurusan + '" data-semester = "' + data.semester + '" data-tahun_ajar = "' + data.tahun_ajar + '" ><i data-feather = "edit" class = "w-4 h-4"> </i> </button>';
                ...
                $(".btn-create").click(function() {
                    ...
                    var keterangan_prestasi = $('.create-keterangan_prestasi').val();
                    var nilai_prestasi = $('.create-nilai_prestasi').val();
                    ...
                    formData.append('keterangan_prestasi', keterangan_prestasi);
                    formData.append('nilai_prestasi', nilai_prestasi);
                    ...
                    $.ajax({
                        url: "http://127.0.0.1:8000/api/nilai-prestasi/tambah-prestasi",
                        type: 'POST',
                        dataType: 'json',
                        headers: {
                            "Authorization": "Bearer " + token
                        ...
                        success: function(response) {
                            ...
                            console.log('Data Prestasi Berhasil di Tambahkan!');
                        ...
                        error: function(xhr, status, error) {
                            ...
                            console.log('Data Prestasi Gagal untuk di Tambahkan. Status: ' + error);
                ...
                $('#data-table').on('click', '.btn-edit', function() {
                    ...
                    var keterangan_prestasi = $(this).attr("data-keterangan_prestasi");
                    var nilai_prestasi = $(this).attr("data-nilai_prestasi");
                    ...
                    $('.update-keterangan_prestasi').val(keterangan_prestasi);
                    $('.update-nilai_prestasi').val(nilai_prestasi);
                ...
                $(".btn-update").click(function() {
                    ...
                    var keterangan_prestasi = $('.update-keterangan_prestasi').val();
                    var nilai_prestasi = $('.update-nilai_prestasi').val();
                    ...
                    $.ajax({
                        url: "http://127.0.0.1:8000/api/nilai-prestasi/update-prestasi/" + id,
                        type: "PUT",
                ...
                $('#data-table').on('click', '.btn-delete', function() {
                    ...
                    $('.hapus-btn').click(function() {
                        //ajax delete API
                        $.ajax({
                            url: "http://127.0.0.1:8000/api/nilai-prestasi/delete-prestasi/" + id,
                            type: 'DELETE',
                            headers: {
                                'Authorization': 'Bearer ' + token
                            },
                ...
                $('.modal-import_prestasi').click(function() {
