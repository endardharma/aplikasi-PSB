                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="">
                                ...
                                <li>
                                    <a href="{{ route('kelassiswa') }}" class="side-menu side-menu--active">
                                        <div class="side-menu__icon"> <i data-feather="plus"></i> </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    {{-- <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <input type="text" class="form-control create-nis" name="nis" id="nis" placeholder="Masukkan Kelas Siswa" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Kelas ID</label>
                                        <input type="text" class="form-control create-kelas_id" name="kelas_id" id="kelas_id" placeholder="Masukkan Kelas ID" required>
                                    </div> --}}
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">NIS</label>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Berhasil Menambahkan Data Kelas Siswa Baru!</div>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Oops...Gagal Menambahkan Data Kelas Siswa Baru!</div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <input type="text" class="form-control update-nis" name="nis" id="nis" placeholder="Masukkan Kelas Siswa" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Kelas ID</label>
                                        <input type="text" class="form-control update-kelas_id" name="kelas_id" id="kelas_id" placeholder="Masukkan Kelas ID" required>
                                    </div>
                                </div>
                                <!-- END: Modal Body -->
                                <!-- BEGIN: Modal Footer -->
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Berhasil update data Kelas Siswa baru!</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="x-circle" class="w-16 h-16 text-theme-23 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Oops...Gagal update data Kelas Siswa  baru!</div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Apa kamu yakin ingin hapus data Kelas Siswa s ini?</div>
                                        <div class="text-gray-600 mt-2">
                                            Apa kamu yakin akan menghapus data Kelas Siswa ini?
                                            <br>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="check-circle" class="w-16 h-16 text-theme-10 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Hapus Data Kelas Siswa Berhasil!</div>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('#data-table').DataTable({
                    ...
                    "serverside": true,
                    "ajax": {
                        "url": "http://127.0.0.1:8000/api/kelas-siswa/list",
                        "dataType": "json",
                        "type": "POST",
                        "headers": {
                            'Authorization': 'Bearer ' + token
                    ...
                    "columns": [
                        ...
                        { data: 'kelas_id', className: 'text-center' },
                        {
                            ...
                            render: function (data, type, row){
                                ...
                                var editBtn = '<button class = "btn btn-primary btn-edit" data-id = "' + data.id + '" data-nis = "' + data.nis + '" data-kelas_id = "' + data.kelas_id + '" ><i data-feather = "edit" class = "w-4 h-4"> </i> </button>';
                ...
                $(".modal-kelas_siswa").click(function() {
                ...
                $(".btn-create").click(function() {
                    ...
                    var kelas_id = $('.create-kelas_id').val();
                    ...
                    $.ajax({
                        url: "http://127.0.0.1:8000/api/kelas-siswa/tambah-kelas_siswa",
                        type: 'POST',
                        dataType: 'json',
                        headers: {
                            "Authorization": "Bearer " + token
                        ...
                        success: function(response) {
                            ...
                            console.log('Data Kelas Siswa Berhasil di Tambahkan!');
                        ...
                        error: function(xhr, status, error) {
                            ...
                            console.log('Data Kelas Siswa Gagal untuk di Tambahkan. Status: ' + error);
                ...
                $(".btn-update").click(function() {
                    ...
                    var kelas_id = $('.update-kelas_id').val();
                    ...
                    // Kirim permintaan pembaruan produk ke API
                    $.ajax({
                        url: "http://127.0.0.1:8000/api/kelas-siswa/update-kelas_siswa/" + id,
                        type: "PUT",
                ...
                $('#data-table').on('click', '.btn-delete', function() {
                    ...
                    $('.hapus-btn').click(function() {
                        // Ajax delete Api
                        $.ajax({
                            url: "http://127.0.0.1:8000/api/kelas-siswa/hapus-kelas_siswa/" + id,
                            type: 'DELETE',
                            headers: {
                                'Authorization': 'Bearer ' + token
                            },
