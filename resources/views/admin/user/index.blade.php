                ...
                <nav class="side-nav">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="">
                                <li>
                                    <a href="{{route('user')}}" class="side-menu side-menu--active">
                    ...
                    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                        ...
                        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                            <div class="intro-y col-span-12 flex flex-weap sm:flex-nowrap items-center mt-2">
                                <button class="btn btn-primary shadow-md mr-2 modal-user">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Nama User</label>
                                        <input type="text" class="form-control create-name" name="name" id="name" placeholder="Masukkan Nama User" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Email</label>
                                        <input type="text" class="form-control create-email" name="email" id="email" placeholder="Masukkan Email" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Password</label>
                                        <input type="password" class="form-control create-password" name="password" id="password" placeholder="Masukkan password" required>
                                    </div>
                                    {{-- <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Role ID</label>
                                        <select class="form-select create-role_id" name="role_id" id="role_id" required>
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <select class="form-select create-role_id" id="role_id" name="role_id">
                                            <option selected disabled>--Pilih Role ID--</option>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Berhasil Menambahkan Data User  Baru!</div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <input type="text" class="form-control update-name" name="name" id="name" placeholder="Masukkan Nama User" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Email</label>
                                        <input type="text" class="form-control update-email" name="email" id="email" placeholder="Masukkan Email" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Password</label>
                                        <input type="password" class="form-control update-password" name="password" id="password" placeholder="Masukkan password" required>
                                    </div>
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Role ID</label>
                                        <input type="text" class="form-control update-role_id" name="role_id" id="role_id" placeholder="Masukkan RoleID" readonly>
                                    </div>
                                    {{-- <div class="col-span-12 sm:col-span-12">
                                        <label for="modal-form-1" class="form-label">Role ID</label>
                                        <select class="form-select update-role_id" name="role_id" id="role_id" required>
                                            <option selected disabled> --- Pilih Role ID --- </option>
                                            <option value="1"> Team IT </option>
                                            <option value="2"> Siswa - Siswi </option>
                                            <option value="3"> Guru BK</option>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Berhasil update data User baru!</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="x-circle" class="w-16 h-16 text-theme-23 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Oops...Gagal update data User  baru!</div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        ...
                                        <div class="text-3xl mt-5">Apa kamu yakin ingin hapus data User s ini?</div>
                                        <div class="text-gray-600 mt-2">
                                            Apa kamu yakin akan menghapus data User ini?
                                            <br>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="p-5 text-center">
                                        <i data-feather="check-circle" class="w-16 h-16 text-theme-10 mx-auto mt-3"></i>
                                        <div class="text-3xl mt-5">Hapus Data User Berhasil!</div>
            ...
            $(document).ready(function(){
                ...
                $('#data-table').DataTable({
                    ...
                    "columns": [
                        ...
                        { data: 'role_id', className: 'text-center' },
                        {
                            data: null,
                            render: function (data, type, row){
                                // create action button
                                var editBtn = '<button class = "btn btn-primary btn-edit" data-id = "' + data.id + '" data-name = "' + data.name + '" data-email = "' + data.email + '" data-password = "' + data.password + '" data-role_id = "' + data.role_id +  '"><i data-feather = "edit" class = "w-4 h-4"> </i> </button>';
                ...
                $(".btn-create").click(function() {
                    ...
                    var role_id = $('.create-role_id').val();
                    ...
                    $.ajax({
                        url: "http://127.0.0.1:8000/api/user/tambah-user",
                        type: 'POST',
                        dataType: 'json',
                        headers: {
                            "Authorization": "Bearer " + token
                        ...
                        success: function(response) {
                            ...
                            console.log('Data User Berhasil di Tambahkan!');
                        ...
                        error: function(xhr, status, error) {
                            ...
                            console.log('Data User Gagal untuk di Tambahkan. Status: ' + error);
                ...
                $('#data-table').on('click', '.btn-edit', function() {
                    ...
                    // {
                    //     jbt = 1;
                    // } else if (role_id == 'Siswa - Siswi') 
                    // {
                    //     jbt = 2;
                    // } else if (role_id == 'Guru BK') 
                    // {
                    //     jbt = 3;
                ...
                $('#data-table').on('click', '.btn-delete', function() {
                    ...
                    $('.hapus-btn').click(function() {
                        // Ajax delete Api
                        $.ajax({
                            url: "http://127.0.0.1:8000/api/user/hapus-user/" + id,
                            type: 'DELETE',
                            headers: {
                                'Authorization': 'Bearer ' + token
                            },
